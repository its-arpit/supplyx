                        ...
                        ?>
                                <tr>
                                    ...
                                    <?php if($item[9] != 0){
                                        ...
                                        // print_r($res_tax);
                                    ?>
                                    <td><?php echo $tax_amount1. " (".$res_tax[0]['percentage']."%) ".$res_tax[0]['title']; array_push($total_tax, $res_tax[0]['percentage']); $total_tax_amt += $tax_amount1; }else{ ?><br></td>
                                    <td><?= "0 %";} ?><br></td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<?= $item[2] ?><br></td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<?= $item[7] ?><br></td>
